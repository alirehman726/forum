  ...
  <body>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <img src="https://source.unsplash.com/2400x700/?coding,dart" class="d-block w-100" alt="...">
          </div>
        </div>
    ...
    <div class="container my-5" id="ques">
        <h2 class="text-center my-5">Welcome to I-Discuss Forums</h2>
          ...
          <?php 
            ...
            while($row = mysqli_fetch_assoc($result)) {
              ...
              <div class="card" style="width: 18rem;">
                <img src="https://source.unsplash.com/1600x900/?' . $cat . ' ,coding" class="card-img-top" alt="Image for a category">
                <div class="card-body">
